...
//****************************Additional operation ***********************************************
readin_statement_t* new_readin_statement(char* inname)
{
   readin_statement_t* i=malloc(sizeof(readin_statement_t));
   i->filename=inname;
   return i;
}
/*************************************************************************************************/
...
void free_set_statement(set_statement_t* i){
   ...
   //****************************Additional operation ***********************************************
void free_readin_statement(readin_statement_t* i){
   if(!i) return;
   free(i->filename);
   free(i);
}
